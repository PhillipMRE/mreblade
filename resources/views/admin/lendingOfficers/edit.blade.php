...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.lendingOfficer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.lending-officers.update", [$lendingOfficer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="published" value="0">
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $lendingOfficer->published || old('published', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $lendingOfficer->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('display_name') ? 'is-invalid' : '' }}" type="text" name="display_name" id="display_name" value="{{ old('display_name', $lendingOfficer->display_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify_phone') ? 'is-invalid' : '' }}" type="text" name="notify_phone" id="notify_phone" value="{{ old('notify_phone', $lendingOfficer->notify_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_phone') ? 'is-invalid' : '' }}" type="text" name="contact_phone" id="contact_phone" value="{{ old('contact_phone', $lendingOfficer->contact_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timezone') ? 'is-invalid' : '' }}" type="text" name="timezone" id="timezone" value="{{ old('timezone', $lendingOfficer->timezone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('license') ? 'is-invalid' : '' }}" type="text" name="license" id="license" value="{{ old('license', $lendingOfficer->license) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $lendingOfficer->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $lendingOfficer->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $lendingOfficer->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $lendingOfficer->linkedin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $lendingOfficer->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $lendingOfficer->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('settings') ? 'is-invalid' : '' }}" type="text" name="settings" id="settings" value="{{ old('settings', $lendingOfficer->settings) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office') ? 'is-invalid' : '' }}" type="text" name="office" id="office" value="{{ old('office', $lendingOfficer->office) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('template') ? 'is-invalid' : '' }}" name="template" id="template">{{ old('template', $lendingOfficer->template) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('user_confirmed_info') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="user_confirmed_info" id="user_confirmed_info" value="1" {{ $lendingOfficer->user_confirmed_info || old('user_confirmed_info', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('demo') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="demo" id="demo" value="1" {{ $lendingOfficer->demo || old('demo', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('rates') ? 'is-invalid' : '' }}" name="rates" id="rates">{{ old('rates', $lendingOfficer->rates) }}</textarea>
                @if($errors->has('rates'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rates') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hubspot') ? 'is-invalid' : '' }}" type="text" name="hubspot" id="hubspot" value="{{ old('hubspot', $lendingOfficer->hubspot) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remote') ? 'is-invalid' : '' }}" name="remote" id="remote">{{ old('remote', $lendingOfficer->remote) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('welcome_sent') ? 'is-invalid' : '' }}" type="text" name="welcome_sent" id="welcome_sent" value="{{ old('welcome_sent', $lendingOfficer->welcome_sent) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('phone_numbers') ? 'is-invalid' : '' }}" name="phone_numbers[]" id="phone_numbers" multiple>
                    @foreach($phone_numbers as $id => $phone_number)
                        <option value="{{ $id }}" {{ (in_array($id, old('phone_numbers', [])) || $lendingOfficer->phone_numbers->contains($id)) ? 'selected' : '' }}>{{ $phone_number }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('phone') ? 'is-invalid' : '' }}" name="phone_id" id="phone_id">
                    @foreach($phones as $id => $entry)
                        <option value="{{ $id }}" {{ (old('phone_id') ? old('phone_id') : $lendingOfficer->phone->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
