...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.smsTemplateDefault.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sms-template-defaults.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_share_buyer') ? 'is-invalid' : '' }}" name="app_share_buyer" id="app_share_buyer">{{ old('app_share_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_share_agent') ? 'is-invalid' : '' }}" name="app_share_agent" id="app_share_agent">{{ old('app_share_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_share_lending_officer') ? 'is-invalid' : '' }}" name="app_share_lending_officer" id="app_share_lending_officer">{{ old('app_share_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_delivered_buyer') ? 'is-invalid' : '' }}" name="app_delivered_buyer" id="app_delivered_buyer">{{ old('app_delivered_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_delivered_agent') ? 'is-invalid' : '' }}" name="app_delivered_agent" id="app_delivered_agent">{{ old('app_delivered_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('app_delivered_lending_officer') ? 'is-invalid' : '' }}" name="app_delivered_lending_officer" id="app_delivered_lending_officer">{{ old('app_delivered_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_viewed_agent') ? 'is-invalid' : '' }}" name="listing_viewed_agent" id="listing_viewed_agent">{{ old('listing_viewed_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_viewed_lending_officer') ? 'is-invalid' : '' }}" name="listing_viewed_lending_officer" id="listing_viewed_lending_officer">{{ old('listing_viewed_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_shared_buyer') ? 'is-invalid' : '' }}" name="listing_shared_buyer" id="listing_shared_buyer">{{ old('listing_shared_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_shared_agent') ? 'is-invalid' : '' }}" name="listing_shared_agent" id="listing_shared_agent">{{ old('listing_shared_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_shared_lending_officer') ? 'is-invalid' : '' }}" name="listing_shared_lending_officer" id="listing_shared_lending_officer">{{ old('listing_shared_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_favorited_agent') ? 'is-invalid' : '' }}" name="listing_favorited_agent" id="listing_favorited_agent">{{ old('listing_favorited_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listing_favorited_lending_officer') ? 'is-invalid' : '' }}" name="listing_favorited_lending_officer" id="listing_favorited_lending_officer">{{ old('listing_favorited_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('request_showing_agent') ? 'is-invalid' : '' }}" name="request_showing_agent" id="request_showing_agent">{{ old('request_showing_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('request_showing_lending_officer') ? 'is-invalid' : '' }}" name="request_showing_lending_officer" id="request_showing_lending_officer">{{ old('request_showing_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('quote_request_lending_officer') ? 'is-invalid' : '' }}" name="quote_request_lending_officer" id="quote_request_lending_officer">{{ old('quote_request_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('referred_lending_officer') ? 'is-invalid' : '' }}" name="referred_lending_officer" id="referred_lending_officer">{{ old('referred_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('welcome_sent_from_admin_lending_officer') ? 'is-invalid' : '' }}" name="welcome_sent_from_admin_lending_officer" id="welcome_sent_from_admin_lending_officer">{{ old('welcome_sent_from_admin_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('welcome_sent_from_admin_agent') ? 'is-invalid' : '' }}" name="welcome_sent_from_admin_agent" id="welcome_sent_from_admin_agent">{{ old('welcome_sent_from_admin_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('shared_property_alert_agent') ? 'is-invalid' : '' }}" name="shared_property_alert_agent" id="shared_property_alert_agent">{{ old('shared_property_alert_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('shared_property_alert_buyer') ? 'is-invalid' : '' }}" name="shared_property_alert_buyer" id="shared_property_alert_buyer">{{ old('shared_property_alert_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('shared_property_alert_lending_officer') ? 'is-invalid' : '' }}" name="shared_property_alert_lending_officer" id="shared_property_alert_lending_officer">{{ old('shared_property_alert_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('favorited_changed_buyer') ? 'is-invalid' : '' }}" name="favorited_changed_buyer" id="favorited_changed_buyer">{{ old('favorited_changed_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('new_property_alert_buyer') ? 'is-invalid' : '' }}" name="new_property_alert_buyer" id="new_property_alert_buyer">{{ old('new_property_alert_buyer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('off_hours_agent') ? 'is-invalid' : '' }}" name="off_hours_agent" id="off_hours_agent">{{ old('off_hours_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('returning_client_agent') ? 'is-invalid' : '' }}" name="returning_client_agent" id="returning_client_agent">{{ old('returning_client_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('direct_registration_agent') ? 'is-invalid' : '' }}" name="direct_registration_agent" id="direct_registration_agent">{{ old('direct_registration_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('direct_registration_lending_officer') ? 'is-invalid' : '' }}" name="direct_registration_lending_officer" id="direct_registration_lending_officer">{{ old('direct_registration_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('sms_reply_lending_officer') ? 'is-invalid' : '' }}" name="sms_reply_lending_officer" id="sms_reply_lending_officer">{{ old('sms_reply_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('sms_reply_agent') ? 'is-invalid' : '' }}" name="sms_reply_agent" id="sms_reply_agent">{{ old('sms_reply_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listings_new_agent') ? 'is-invalid' : '' }}" name="listings_new_agent" id="listings_new_agent">{{ old('listings_new_agent') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('listings_new_lending_officer') ? 'is-invalid' : '' }}" name="listings_new_lending_officer" id="listings_new_lending_officer">{{ old('listings_new_lending_officer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('unreachable_client_agent') ? 'is-invalid' : '' }}" name="unreachable_client_agent" id="unreachable_client_agent">{{ old('unreachable_client_agent') }}</textarea>
