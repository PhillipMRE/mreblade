...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-authorPosts">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($posts as $key => $post)
                        <tr data-entry-id="{{ $post->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $post->sticky ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $post->sticky ? 'checked' : '' }}>
                            </td>
                            <td>
                                @can('post_show')
...
@endcan
  ...
  let table = $('.datatable-authorPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
