    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.quotes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_price') ? 'is-invalid' : '' }}" type="text" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('down_payment') ? 'is-invalid' : '' }}" type="text" name="down_payment" id="down_payment" value="{{ old('down_payment', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit_score') ? 'is-invalid' : '' }}" type="text" name="credit_score" id="credit_score" value="{{ old('credit_score', '') }}">
