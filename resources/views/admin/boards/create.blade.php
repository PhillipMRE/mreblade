        ...
        <form method="POST" action="{{ route("admin.boards.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_courtesy') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_courtesy" id="show_courtesy" value="1" {{ old('show_courtesy', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('prominent_courtesy_of') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="prominent_courtesy_of" id="prominent_courtesy_of" value="1" {{ old('prominent_courtesy_of', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('disclaimer') ? 'is-invalid' : '' }}" name="disclaimer" id="disclaimer">{{ old('disclaimer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('general_area') ? 'is-invalid' : '' }}" name="general_area" id="general_area">{{ old('general_area') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('agent_roster') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="agent_roster" id="agent_roster" value="1" {{ old('agent_roster', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('sold_data') ? 'is-invalid' : '' }}" name="sold_data" id="sold_data">{{ old('sold_data') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('strict_customer') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="strict_customer" id="strict_customer" value="1" {{ old('strict_customer', 0) == 1 || old('strict_customer') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('expand_courtesy_by_default') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="expand_courtesy_by_default" id="expand_courtesy_by_default" value="1" {{ old('expand_courtesy_by_default', 0) == 1 || old('expand_courtesy_by_default') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('include_office_name_on_listing') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="include_office_name_on_listing" id="include_office_name_on_listing" value="1" {{ old('include_office_name_on_listing', 0) == 1 || old('include_office_name_on_listing') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('include_agent_name_on_listing') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="include_agent_name_on_listing" id="include_agent_name_on_listing" value="1" {{ old('include_agent_name_on_listing', 0) == 1 || old('include_agent_name_on_listing') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_tooltip_on_non_mls_data') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_tooltip_on_non_mls_data" id="show_tooltip_on_non_mls_data" value="1" {{ old('show_tooltip_on_non_mls_data', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hide_days_on_market') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hide_days_on_market" id="hide_days_on_market" value="1" {{ old('hide_days_on_market', 0) == 1 || old('hide_days_on_market') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom') ? 'is-invalid' : '' }}" type="text" name="zoom" id="zoom" value="{{ old('zoom', '') }}">
                @if($errors->has('zoom'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zoom') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_sync_at') ? 'is-invalid' : '' }}" type="text" name="last_sync_at" id="last_sync_at" value="{{ old('last_sync_at') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('private_note') ? 'is-invalid' : '' }}" name="private_note" id="private_note">{{ old('private_note') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('public_note') ? 'is-invalid' : '' }}" name="public_note" id="public_note">{!! old('public_note') !!}</textarea>
