    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rates') ? 'is-invalid' : '' }}" type="text" name="rates" id="rates" value="{{ old('rates', '') }}">
                @if($errors->has('rates'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rates') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('technical_contact_email') ? 'is-invalid' : '' }}" type="email" name="technical_contact_email" id="technical_contact_email" value="{{ old('technical_contact_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level') ? 'is-invalid' : '' }}" type="text" name="level" id="level" value="{{ old('level', 'standard') }}">
                @if($errors->has('level'))
                    <div class="invalid-feedback">
                        {{ $errors->first('level') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('disclosure') ? 'is-invalid' : '' }}" name="disclosure" id="disclosure">{{ old('disclosure') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('estimated_mortgage_disclosure') ? 'is-invalid' : '' }}" name="estimated_mortgage_disclosure" id="estimated_mortgage_disclosure">{{ old('estimated_mortgage_disclosure') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('block_mre') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="block_mre" id="block_mre" value="1" {{ old('block_mre', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('block_login_as') ? 'is-invalid' : '' }}" type="number" name="block_login_as" id="block_login_as" value="{{ old('block_login_as', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ep') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ep" id="ep" value="1" {{ old('ep', 0) == 1 ? 'checked' : '' }}>
