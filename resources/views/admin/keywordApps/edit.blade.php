...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.keywordApp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.keyword-apps.update", [$keywordApp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.keywordApp.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $keywordApp->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_name') ? 'is-invalid' : '' }}" type="text" name="short_name" id="short_name" value="{{ old('short_name', $keywordApp->short_name) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $keywordApp->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('template') ? 'is-invalid' : '' }}" name="template" id="template">{{ old('template', $keywordApp->template) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apple_version') ? 'is-invalid' : '' }}" type="text" name="apple_version" id="apple_version" value="{{ old('apple_version', $keywordApp->apple_version) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_version') ? 'is-invalid' : '' }}" type="text" name="google_version" id="google_version" value="{{ old('google_version', $keywordApp->google_version) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apple_mre_version') ? 'is-invalid' : '' }}" type="text" name="apple_mre_version" id="apple_mre_version" value="{{ old('apple_mre_version', $keywordApp->apple_mre_version) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_mre_version') ? 'is-invalid' : '' }}" type="text" name="google_mre_version" id="google_mre_version" value="{{ old('google_mre_version', $keywordApp->google_mre_version) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apple') ? 'is-invalid' : '' }}" type="text" name="apple" id="apple" value="{{ old('apple', $keywordApp->apple) }}">
                @if($errors->has('apple'))
                    <div class="invalid-feedback">
                        {{ $errors->first('apple') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google') ? 'is-invalid' : '' }}" type="text" name="google" id="google" value="{{ old('google', $keywordApp->google) }}">
