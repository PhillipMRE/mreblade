        ...
        <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('archived') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="archived" id="archived" value="1" {{ $client->archived || old('archived', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('claimed') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="claimed" id="claimed" value="1" {{ $client->claimed || old('claimed', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('agent') ? 'is-invalid' : '' }}" name="agent_id" id="agent_id">
                    @foreach($agents as $id => $entry)
                        <option value="{{ $id }}" {{ (old('agent_id') ? old('agent_id') : $client->agent->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('agent'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('settings') ? 'is-invalid' : '' }}" type="text" name="settings" id="settings" value="{{ old('settings', $client->settings) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $client->category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stub') ? 'is-invalid' : '' }}" type="text" name="stub" id="stub" value="{{ old('stub', $client->stub) }}">
                @if($errors->has('stub'))
                    <div class="invalid-feedback">
                        {{ $errors->first('stub') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('muted') ? 'is-invalid' : '' }}" type="text" name="muted" id="muted" value="{{ old('muted', $client->muted) }}">
                @if($errors->has('muted'))
                    <div class="invalid-feedback">
                        {{ $errors->first('muted') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('muted_at') ? 'is-invalid' : '' }}" type="text" name="muted_at" id="muted_at" value="{{ old('muted_at', $client->muted_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source') ? 'is-invalid' : '' }}" type="text" name="source" id="source" value="{{ old('source', $client->source) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_source') ? 'is-invalid' : '' }}" type="text" name="sub_source" id="sub_source" value="{{ old('sub_source', $client->sub_source) }}">
