...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.statusType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.status-types.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('listing_status') ? 'is-invalid' : '' }}" type="text" name="listing_status" id="listing_status" value="{{ old('listing_status', '') }}">
