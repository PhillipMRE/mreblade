    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.listings.update", [$listing->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_number') ? 'is-invalid' : '' }}" type="text" name="street_number" id="street_number" value="{{ old('street_number', $listing->street_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_name') ? 'is-invalid' : '' }}" type="text" name="street_name" id="street_name" value="{{ old('street_name', $listing->street_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_type') ? 'is-invalid' : '' }}" type="text" name="street_type" id="street_type" value="{{ old('street_type', $listing->street_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_direction') ? 'is-invalid' : '' }}" type="text" name="street_direction" id="street_direction" value="{{ old('street_direction', $listing->street_direction) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_number') ? 'is-invalid' : '' }}" type="text" name="unit_number" id="unit_number" value="{{ old('unit_number', $listing->unit_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $listing->city) }}">
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $listing->state) }}">
                @if($errors->has('state'))
                    <div class="invalid-feedback">
                        {{ $errors->first('state') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $listing->zip) }}">
                @if($errors->has('zip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('list_price') ? 'is-invalid' : '' }}" type="text" name="list_price" id="list_price" value="{{ old('list_price', $listing->list_price) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selling_price') ? 'is-invalid' : '' }}" type="text" name="selling_price" id="selling_price" value="{{ old('selling_price', $listing->selling_price) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arch_style') ? 'is-invalid' : '' }}" type="text" name="arch_style" id="arch_style" value="{{ old('arch_style', $listing->arch_style) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parking_spaces') ? 'is-invalid' : '' }}" type="text" name="parking_spaces" id="parking_spaces" value="{{ old('parking_spaces', $listing->parking_spaces) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('public_remarks') ? 'is-invalid' : '' }}" name="public_remarks" id="public_remarks">{{ old('public_remarks', $listing->public_remarks) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('private_remarks') ? 'is-invalid' : '' }}" name="private_remarks" id="private_remarks">{{ old('private_remarks', $listing->private_remarks) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('area') ? 'is-invalid' : '' }}" type="text" name="area" id="area" value="{{ old('area', $listing->area) }}">
                @if($errors->has('area'))
                    <div class="invalid-feedback">
                        {{ $errors->first('area') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('open_house_date') ? 'is-invalid' : '' }}" type="text" name="open_house_date" id="open_house_date" value="{{ old('open_house_date', $listing->open_house_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('open_house_time') ? 'is-invalid' : '' }}" type="text" name="open_house_time" id="open_house_time" value="{{ old('open_house_time', $listing->open_house_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $listing->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $listing->longitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('elem_school') ? 'is-invalid' : '' }}" type="text" name="elem_school" id="elem_school" value="{{ old('elem_school', $listing->elem_school) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mid_school') ? 'is-invalid' : '' }}" type="text" name="mid_school" id="mid_school" value="{{ old('mid_school', $listing->mid_school) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('high_school') ? 'is-invalid' : '' }}" type="text" name="high_school" id="high_school" value="{{ old('high_school', $listing->high_school) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district_school') ? 'is-invalid' : '' }}" type="text" name="district_school" id="district_school" value="{{ old('district_school', $listing->district_school) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('misc_school') ? 'is-invalid' : '' }}" type="text" name="misc_school" id="misc_school" value="{{ old('misc_school', $listing->misc_school) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_1') ? 'is-invalid' : '' }}" type="text" name="m_1" id="m_1" value="{{ old('m_1', $listing->m_1) }}">
                @if($errors->has('m_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_2') ? 'is-invalid' : '' }}" type="text" name="m_2" id="m_2" value="{{ old('m_2', $listing->m_2) }}">
                @if($errors->has('m_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_3') ? 'is-invalid' : '' }}" type="text" name="m_3" id="m_3" value="{{ old('m_3', $listing->m_3) }}">
                @if($errors->has('m_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_4') ? 'is-invalid' : '' }}" type="text" name="m_4" id="m_4" value="{{ old('m_4', $listing->m_4) }}">
                @if($errors->has('m_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_5') ? 'is-invalid' : '' }}" type="text" name="m_5" id="m_5" value="{{ old('m_5', $listing->m_5) }}">
                @if($errors->has('m_5'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_5') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_6') ? 'is-invalid' : '' }}" type="text" name="m_6" id="m_6" value="{{ old('m_6', $listing->m_6) }}">
                @if($errors->has('m_6'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_6') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_7') ? 'is-invalid' : '' }}" type="text" name="m_7" id="m_7" value="{{ old('m_7', $listing->m_7) }}">
                @if($errors->has('m_7'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_7') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_8') ? 'is-invalid' : '' }}" type="text" name="m_8" id="m_8" value="{{ old('m_8', $listing->m_8) }}">
                @if($errors->has('m_8'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_8') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('m_9') ? 'is-invalid' : '' }}" type="text" name="m_9" id="m_9" value="{{ old('m_9', $listing->m_9) }}">
                @if($errors->has('m_9'))
                    <div class="invalid-feedback">
                        {{ $errors->first('m_9') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_1') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_1" id="f_1" value="1" {{ $listing->f_1 || old('f_1', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_2') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_2" id="f_2" value="1" {{ $listing->f_2 || old('f_2', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_3') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_3" id="f_3" value="1" {{ $listing->f_3 || old('f_3', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_4') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_4" id="f_4" value="1" {{ $listing->f_4 || old('f_4', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_5" id="f_5" value="1" {{ $listing->f_5 || old('f_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_6') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_6" id="f_6" value="1" {{ $listing->f_6 || old('f_6', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_7') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_7" id="f_7" value="1" {{ $listing->f_7 || old('f_7', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_8" id="f_8" value="1" {{ $listing->f_8 || old('f_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_9') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_9" id="f_9" value="1" {{ $listing->f_9 || old('f_9', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_10') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_10" id="f_10" value="1" {{ $listing->f_10 || old('f_10', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_11') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_11" id="f_11" value="1" {{ $listing->f_11 || old('f_11', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_12" id="f_12" value="1" {{ $listing->f_12 || old('f_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_13') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_13" id="f_13" value="1" {{ $listing->f_13 || old('f_13', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_14" id="f_14" value="1" {{ $listing->f_14 || old('f_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_15') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_15" id="f_15" value="1" {{ $listing->f_15 || old('f_15', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_16') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_16" id="f_16" value="1" {{ $listing->f_16 || old('f_16', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_17') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_17" id="f_17" value="1" {{ $listing->f_17 || old('f_17', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_18') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_18" id="f_18" value="1" {{ $listing->f_18 || old('f_18', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_19') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_19" id="f_19" value="1" {{ $listing->f_19 || old('f_19', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_20') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_20" id="f_20" value="1" {{ $listing->f_20 || old('f_20', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('f_21') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="f_21" id="f_21" value="1" {{ $listing->f_21 || old('f_21', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('house_type') ? 'is-invalid' : '' }}" type="text" name="house_type" id="house_type" value="{{ old('house_type', $listing->house_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sale_rent') ? 'is-invalid' : '' }}" type="text" name="sale_rent" id="sale_rent" value="{{ old('sale_rent', $listing->sale_rent) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('ts') ? 'is-invalid' : '' }}" type="text" name="ts" id="ts" value="{{ old('ts', $listing->ts) }}">
                @if($errors->has('ts'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ts') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_status') ? 'is-invalid' : '' }}" type="text" name="add_status" id="add_status" value="{{ old('add_status', $listing->add_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('selling_date') ? 'is-invalid' : '' }}" type="text" name="selling_date" id="selling_date" value="{{ old('selling_date', $listing->selling_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prev_price') ? 'is-invalid' : '' }}" type="number" name="prev_price" id="prev_price" value="{{ old('prev_price', $listing->prev_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('price_change_date') ? 'is-invalid' : '' }}" type="text" name="price_change_date" id="price_change_date" value="{{ old('price_change_date', $listing->price_change_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('class_name') ? 'is-invalid' : '' }}" type="text" name="class_name" id="class_name" value="{{ old('class_name', $listing->class_name) }}">
