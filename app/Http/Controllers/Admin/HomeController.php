...
class HomeController
{
    public function index()
    {
        ...
        $settings4 = [
            'chart_title'           => 'Lending Officers',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\LendingOfficer',
            'group_by_field'        => 'welcome_sent',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            'group_by_field_format' => 'Y-m-d H:i:s',
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'lendingOfficer',
        ];
        ...
        $settings5 = [
            'chart_title'           => 'Sponsors',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Sponsor',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
        ...
        return view('home', compact('chart8', 'settings1', 'settings2', 'settings3', 'settings4', 'settings5', 'settings6', 'settings7'));
    }
}
